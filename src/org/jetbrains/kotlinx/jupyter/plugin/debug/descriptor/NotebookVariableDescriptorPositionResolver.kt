...
object NotebookVariableDescriptorPositionResolver : DeclaredVariableSourcePositionProvider {
    override fun resolveTo(descriptor: NotebookVariableStateDescriptor): SourcePosition? {
        val vFile = descriptor.virtualFile ?: return null
        val project = descriptor.project
        if (!vFile.file.isKotlinNotebook) return null
