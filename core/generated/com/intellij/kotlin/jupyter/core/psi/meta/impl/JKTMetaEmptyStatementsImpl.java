...
public class JKTMetaEmptyStatementsImpl extends ASTWrapperPsiElement implements JKTMetaEmptyStatements {

  public JKTMetaEmptyStatementsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JKTMetaVisitor visitor) {
    visitor.visitEmptyStatements(this);
  }
