...
package com.intellij.kotlin.jupyter.core.debug
...
import com.intellij.kotlin.jupyter.core.debug.util.updateInfoBeforeExecution
...
class KotlinNotebookDebugRunner(project: Project, private val virtualFile: BackedNotebookVirtualFile) : NotebookDebugRunner {
    ...
    override fun createDebugSession(
      ...
      afterCellExecuted: () -> Unit
        ...
        val session = JupyterRuntimeService.getInstance(project).getNotebookSession(virtualFile)!!
