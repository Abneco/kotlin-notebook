...
import com.intellij.kotlin.jupyter.core.editor.highlighting.NotebookHighlightingService.Companion.HL_DELAY_PAUSE
import com.intellij.kotlin.jupyter.core.editor.highlighting.service.DaemonAnalyzerStatusService
import com.intellij.kotlin.jupyter.core.editor.highlighting.utils.NotebookHighlightingUtilityObject.shouldStartAfterPreChecks
...
internal object NotebookAnalysisRestarter {
    private var updateJob: Job? = null
    private val regularUpdateScope = KotlinNotebookPluginScope.global
        .childScope("NotebookAnalysisRestarter")
