...
abstract class KotlinNotebookCreateActionBase :
    CreateFileFromTemplateAction(
        KotlinNotebookBundle.message("NewKotlinNotebookAction.text"),
        KotlinNotebookBundle.message("NewKotlinNotebookAction.description"),
