...
internal class CompilerPluginsSettingsBuilderK2 : KotlinNotebookSettingsPanelsBuilder {
    override fun buildJvmAndBuildOptionsSelector(project: Project, settingsPanel: Panel, componentDisposable: Disposable): Row? {
            ...
            group(KotlinNotebookBundle.message("kotlin.notebook.settings.analysis.compiler.plugins.title")) {
                row(KotlinNotebookBundle.message("kotlin.notebook.settings.analysis.compiler.plugins.bundled.title")) {
                    addBundledCompilerPluginsComboBox(optionsProvider)
                        .widthGroup(KotlinNotebookSettingsPanelBuilder.BUILD_WIDTH_GROUP)
                }
            }
        }
    }
